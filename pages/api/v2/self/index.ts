            ...
            if (!confirmCode) {
                            	...
                            	<div style="padding: 1rem; max-width: 30rem; margin-left: auto;margin-right: auto; width: 100%; border-radius: 0.75rem; border-width: 1px; background: rgb(250, 250, 250);">
                            		...
                            		<div>
                                           <p style="white-space: pre-line; color: rgb(0, 0, 0); font-weight: 400; margin-bottom: 0.75rem; overflow-wrap: break-word; font-size: 1rem;">
                            				Hello ${user.username},
                                            To confirm that you want to change your password, please enter the following code into the RestoreWhore website (The code will expire in 30 minutes):
                                            <br />
                                            <b>${code}</b>
                                            <br />
                                    ...
                                    <div style="text-align: center; margin-top: 1rem;">
                                        <em style="color: rb(190, 198, 213)">
                                            Copyright &#169; 2024 Elym Productions, LLC. All rights reserved.
                                        </em>
                                    </div>
                            	</div>
                            </body>
                ...
                await axios.get(`https://ipinfo.io/${getIPAddress(req)}/json?token=${process.env.IPINFO_TOKEN}`).then(async (res) => {
                    await Email.send({
                        to: user.email,
                        from: {
                            email: "no-reply@restorewhore.com",
                            name: "RestoreWhore"
                        },
                        subject: "RestoreWhore Password Changed",
                        html:
                            `
                                <!DOCTYPE html>
                                <html>
                                		...
                                		<div style="padding: 1rem; max-width: 30rem; margin-left: auto;margin-right: auto; width: 100%; border-radius: 0.75rem; border-width: 1px; background: rgb(250, 250, 250);">
                                			...
                                			<div>
                                                <p style="white-space: pre-line; color: rgb(0, 0, 0); font-weight: 400; margin-bottom: 0.75rem; overflow-wrap: break-word; font-size: 1rem;">
                                                    ...
                                                    <b style="font-weight: 600">Device:</b> ${getPlatform(req.headers["user-agent"] ?? "")} (${getBrowser(req.headers["user-agent"] ?? "")})
                                					<b style="font-weight: 600">IP:</b> ${getIPAddress(req)} <br />
                                					If this was not you, contact us immediately at <a style="color: rgb(56,189, 248);" href="mailto:contact@restorewhore.com">contact@restorewhore.com</a> or <a style="color: rgb(56,189, 248);" href="https://t.me/restorewhore">RestoreWhore Telegram</a>.
                                                    If you have any questions, please contact us at <a style="color: rgb(56,189, 248);" href="mailto:contact@restorewhore.com">contact@restorewhore.com</a>.
                                                    <br />
                                                    Sincerely,
                                                    RestoreWhore
            ...
            if (username && password && !code) {
                ...
                await axios.get(`https://ipinfo.io/${getIPAddress(req)}/json?token=${process.env.IPINFO_TOKEN}`).then(async (res) => {
                    ...
                    await Email.send({
                        ...
                        subject: "RestoreWhore Email Change Confirmation",
                        html: `
                            <!DOCTYPE html>
                            <html>
                            	<head>
                            	...
                            	<body>
                            		...
                            		<div style="padding: 1rem; max-width: 30rem; margin-left: auto;margin-right: auto; width: 100%; border-radius: 0.75rem; border-width: 1px; background: rgb(250, 250, 250);">
                            			...
                            			<div>
                                            <p style="white-space: pre-line; color: rgb(0, 0, 0); font-weight: 400; margin-bottom: 0.75rem; overflow-wrap: break-word; font-size: 1rem;">
                            					Hello ${user.username},
                                                To confirm that you want to change your email from ${user.email} to ${email}, please enter the following code into the RestoreWhore website (The code will expire in 30 minutes):
                                                <br />
                                                <b><code>${code}</code></b>
                                                <br />
                            					<b style="font-weight: 600">Location:</b> Near ${res.data.city ?? "Unknown"}, ${res.data.region ?? "Unknown"}, ${res.data.country ?? "Unknown"}
                                                <b style="font-weight: 600">Device:</b> ${getPlatform(req.headers["user-agent"] ?? "")} (${getBrowser(req.headers["user-agent"] ?? "")})
                            					<b style="font-weight: 600">IP:</b> ${getIPAddress(req)} <br />
                            					If this was not you, simply ignore this email or <a style="color: rgb(56,189, 248);" href="https://restorewhore.com/forgot">reset your password</a>.
                                                If you have any questions, please contact us at <a style="color: rgb(56,189, 248);" href="mailto:contact@restorewhore.com">contact@restorewhore.com</a>.
                                                <br />
                                                Sincerely,
                                                RestoreWhore
                                    ...
                                    <div style="padding: 1rem; max-width: 30rem; margin-left: auto;margin-right: auto; width: 100%; border-radius: 0.75rem; border-width: 1px; background: rgb(250, 250, 250);">
                                        ...
                                        <div>
                                            <p style="white-space: pre-line; color: rgb(0, 0, 0); font-weight: 400; margin-bottom: 0.75rem; overflow-wrap: break-word; font-size: 1rem;">
                                                ...
                                                <b style="font-weight: 600">Device:</b> ${getPlatform(req.headers["user-agent"] ?? "")} (${getBrowser(req.headers["user-agent"] ?? "")})
                                                <b style="font-weight: 600">IP:</b> ${getIPAddress(req)} <br />
                                                If this was <b style="color: red">NOT</b> you, contact us immediately at <a style="color: rgb(56,189, 248);" href="mailto:contact@restorewhore.com</a>!
                                                If you have any questions, please contact us at <a style="color: rgb(56,189, 248);" href="mailto:contact@restorewhore.com">contact@restorewhore.com</a>.
                                                <br />
                                                Sincerely,
                                                RestoreCord
                                		...
                                		<div style="padding: 1rem; max-width: 30rem; margin-left: auto;margin-right: auto; width: 100%; border-radius: 0.75rem; border-width: 1px; background: rgb(250, 250, 250);">
                                			...
                                			<div>
                                                <p style="white-space: pre-line; color: rgb(0, 0, 0); font-weight: 400; margin-bottom: 0.75rem; overflow-wrap: break-word; font-size: 1rem;">
                                                    ...
                                                    <b style="font-weight: 600">Device:</b> ${getPlatform(req.headers["user-agent"] ?? "")} (${getBrowser(req.headers["user-agent"] ?? "")})
                                					<b style="font-weight: 600">IP:</b> ${getIPAddress(req)} <br />
                                					If this was not you, contact us immediately at <a style="color: rgb(56,189, 248);" href="mailto:contact@restorewhore.com">contact@restorewhore.com</a> or <a style="color: rgb(56,189, 248);" href="https://t.me/restorecord">RestoreCord Telegram</a>.
                                                    If you have any questions, please contact us at <a style="color: rgb(56,189, 248);" href="mailto:contact@restorewhore.com">contact@restorewhore.com</a>.
                                                    <br />
                                                    Sincerely,
                                                    RestoreCord

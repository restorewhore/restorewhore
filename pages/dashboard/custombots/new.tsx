        ...
        case 0: // Step 1 (Create a bot)
            return (
                <>
                    ...
                    <img src="https://restorewhore.com/setup_create_bot.png" alt="Create a bot" style={{ width: isMobile ? "100%" : "45%", borderRadius: "1rem", display: "flex", margin: "auto" }} />
                    ...
                    <Alert severity="warning" sx={{ mt: 2 }}>
                        ...
                        <Link href="https://docs.restorecord.com/guides/secure-bot" target="_blank" rel="noopener noreferrer">
                            {!isMobile ?
            ...
            return (
                <>
                    ...
                    <Stack direction={isMobile ? "column" : "row"} spacing={2} sx={{ mb: 2 }}>
                        <img src="https://restorewhore.com/setup_find_bot_token.png" alt="Find bot token" style={{ width: isMobile ? "100%" : "45%", borderRadius: "1rem", margin: "auto" }} />
                        <img src="https://restorewhore.com/setup_find_client-secret.png" alt="Find client secret" style={{ width: isMobile ? "100%" : "45%", borderRadius: "1rem", margin: "auto" }} />
                    </Stack>
        ...
        case 2: // Step 3 (Add Redirect url)
            return (
                <>
                    ...
                    <Typography variant="body1" sx={{ mb: 2, color: "text.secondary" }}>Go to your Application&apos;s OAuth2 page and add the following redirect URL:<br/><code onClick={() => { try { navigator.clipboard.writeText("https://restorewhore.com/api/callback"); setNotification({ ...notification, info: { open: true, text: "Copied to clipboard!" } }); } catch {} }} style={{ cursor: "pointer" }}>https://restorewhore.com/api/callback</code></Typography>
                    
                    <img src="https://restorewhore.com/setup_redirect-url.png" alt="Add redirect url" style={{ width: isMobile ? "100%" : "45%", borderRadius: "1rem", display: "flex", margin: "auto" }} />
                </>
            )
            break;

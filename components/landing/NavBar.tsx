            ...
            <ElevationScroll>
                <AppBar component="nav" sx={{ backdropFilter: "blur(1rem)", backgroundColor: "transparent", width: "100%", backgroundImage: "none", background: "rgba(15,15,15,0.5)", borderBottom: "1px solid rgba(255,255,255,0.1)" }}>
                    { <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", width: "100%", height: "auto", color: theme.palette.getContrastText(theme.palette.primary.main), py: 1, px: 2 }}>
                        ...
                        VaultCord is MUCH BETTER, check them out at <span style={{ fontWeight: 900, color: theme.palette.error.main }}><Link href={'https://vaultcord.com'}>https://vaultcord.com</Link></span>
                        </Typography>
                    </Box> }
                        ...
                        <Toolbar>
                            ...
                            <Box sx={{ display: { xs: "flex", md: "none" }, flexGrow: 1 }}>
                                ...
                                <Menu id="menu" anchorEl={anchorEl} open={open} onClose={handleClose} MenuListProps={{ "aria-labelledby": "menu-btn" }}>
                                    <MenuItem onClick={handleClose}>
                                        <Link href="https://t.me/restorewhore" target="_blank">
                                            <ListItemIcon>
                                                <TelegramIcon />
                                            </ListItemIcon>
                                            <ListItemText>Join Telegram</ListItemText>
                                        </Link>
                                    </MenuItem>

                                    <MenuItem onClick={handleClose}>
                                        <Link href="/discovery" target="_blank">
                                        <ListItemIcon>
                                            <Help />
                                        </ListItemIcon>
                            ...
                            <Box sx={{ display: { xs: "none", md: "block" }}}>
                                <Stack direction="row" spacing={1}>
                                    <Button href="https://t.me/restorewhore" target="_blank">
                                        Join Telegram
                                    </Button>

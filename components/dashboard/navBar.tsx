                ...
                <AppBar position="fixed" sx={{ zIndex: (theme) => theme.zIndex.drawer + 1, background: "#0a0a0a", boxShadow: "none", borderBottom: "1px solid rgb(38, 38, 42)" }}>
                    <Toolbar>
                        ...
                        <Stack direction="row" spacing={2} alignItems="center">
                            ...
                            <ButtonBase disableRipple onClick={() => { window.open("https://t.me/restorewhore", "_blank") }} sx={{ display: "flex", alignItems: "center", justifyContent: "center", borderRadius: "14px", padding: "8px 14px", background: "#121212", color: "#ffffff", transition: "all 0.2s ease-in-out", "&:hover": { background: "#1e1e1e" } }}>

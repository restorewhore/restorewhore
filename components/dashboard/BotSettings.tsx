                ...
                <DialogContent>
                    ...
                    {user.bots.find((bot: any) => bot.clientId === id).customDomain ? (
                        ...
                        <>
                            <DialogContentText id="alert-dialog-description">
                                <Typography variant="body1">
                                    You can set a custom domain to your bot. This will allow you to use your own domain for your bot, instead of using restorewhore.com.
                                </Typography>
                                ...
                                {(customDomainSettings.verification.name || customDomainSettings.validation.name || customDomainSettings.status === "pending") && (
                                    <>
                                        ...
                                        <Typography variant="body1" sx={{ mt: 1 }}><b>Value:</b> <CodeCopy>fallback.restorewhore.com</CodeCopy></Typography>
                                    </>
                                )}
                            </DialogContentText>
                            <DialogActions>

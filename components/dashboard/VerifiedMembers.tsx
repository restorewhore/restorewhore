            ...
            <Dialog open={exportOptions.open} onClose={() => setExportOptions({ ...exportOptions, open: false })} maxWidth="sm" fullWidth>
                ...
                <DialogContent sx={{ marginTop: 2 }}>
                    ...
                    <Alert severity="info" sx={{ mt: 2 }}>
                        <Typography variant="body1" sx={{ fontWeight: "500" }}>
                            Transfer to VaultCord
                        </Typography>
                        <Typography variant="body2">
                            You can use this export file to transfer your members to VaultCord! This is what we recommend. Way more features and trusted owner.

                            Watch the <Link href="https://www.youtube.com/watch?v=_ujO3JgqtxI&t=56s" target="_blank">tutorial video here</Link> to transfer members to VaultCord
                        </Typography>
                    </Alert>
